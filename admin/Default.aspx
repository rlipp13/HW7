...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
        <div class="col-md-6 col-md-offset-4 form-inline" role="form" id="search">
            <div class="form-group">
                <label class="sr-only">Search by Movie Name:</label>
    ...
    <div class="row">
    <asp:GridView ID="GridView1" GridLines="None" CssClass="table-hover table"  runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="MovieID" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="MovieID" DataNavigateUrlFormatString="MovieDetails.aspx?MovieID={0}" Text="View Movie"/>
        </Columns>
    </asp:GridView>
        </div>
